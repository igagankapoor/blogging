    ...
    <body class="no-padding">
        <main class="login">
            ...
            <section class="login__column">
                ...
                <a href="">
                <h1 style="font-size:larger; font-family: Arial-Black; font-color: black; margin-top:10px;">Blogging</h1>
            </a>
                    <!-- x   -->
                    ...
                    <a class="login__fb-link" href="#">
                        <i class="fa fa-facebook-square fa-lg" aria-hidden="true"></i> Log in with Google
                    </a>
                </div>
