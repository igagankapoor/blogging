...
<html lang="en">
    ...
    ?>
        ...
        <nav class="navigation">
            <a href="feed.php?username=<?php echo $us?>">
                <h1 style="font-size:larger; font-family: Arial-Black; font-color: black;">Blogging</h1>
            </a>
  ...
  🌙
                ...
                <a href="post.php?username=<?php echo $us?>" class="navigation__link">
                    <img
                        class=" "
                            ...
                            style="width:17px; height:17px" loading="lazy" 
                        />
                </a>
                ...
                <header class="photo__header">
                    ...
                    <div class="photo__header-column">
                        <a href = "profile.php?curr_us=<?php echo $us?>&profile_for=<?php echo $follower?>">
                            <?php echo $follower?>
                            <img height = "13" width = "13"src = "images\verified.png" loading="lazy" />
                        </a>
                    </div>
                </header>
                <div class="photo__file-container">
                    <a href="image-detail.php?post_id=<?php echo $post_id?>&curr_us=<?php echo $us ?>"> <img class="photo__file" loading="lazy"  src=<?php echo $photo?> ></a>
                </div>
        ...
        <footer class="footer">
            ...
            <span class="footer__copyright">© 2025 blogging</span>
        </footer>
        <script
